...
function menu_draw()
	...
	elseif menu_type == 'choice' or menu_type == 'mainyesno' or menu_type == 'quityesno' or menu_type == 'language' then
		if g_system == 'PS3' or menu_type == 'mainyesno' or menu_type == 'quityesno' then
			lg.draw(menu_bg,posX,posY)
		end
		if menu_type == 'choice' then
	...
	elseif menu_type == 'help' then
		...
		if global_os == 'LOVE-WrapLua' and g_system == 'PS3' then
			for i, line in ipairs(tr.help) do
				lg.print(line,160,120+((i-1)*26))
			end
		else
		...
		if global_os == 'LOVE-WrapLua' then
			if g_system == 'PS3' then
				keys = {'Cross, (L1)','Start','(R1)','Triangle','Circle','Select'}
			elseif not lv1lua.confirm then
	...
	elseif menu_type == 'settings' then
		...
		if g_system == 'PS3' then
			if dvertype ~= '' then lg.print(dvertype,dversionx,650) end
			lg.print(dversion,dversionx,675)
			lg.print('AIO + FIX',dversionx,700)
			lg.print('By KiZeo',dversionx,725)
		else
			lg.print(dvertype..'\n'..dversion..'\nAIO + FIX\nBy KiZeo',dversionx,650)
		end
