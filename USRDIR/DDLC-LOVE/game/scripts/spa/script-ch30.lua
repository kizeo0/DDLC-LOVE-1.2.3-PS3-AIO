...
function ch30script()
	...
	elseif cl == 23 then
		cw('m', "Si te lo dije hasta cuando descargaste el PKG")
	elseif cl == 24 then
		cw('m', "Linda consola por cierto.")
	elseif cl == 25 then
	...
	elseif cl == 107 then
	m "Simplemente fuí a «Ajustes» y encontrar el botón «Personajes»..."
	elseif cl == 108 then
	...
	elseif cl >= 205 and cl < 1050 then
		-- P7: antes era loadstring('ch30_'..monikatopic..'()')(), que compilaba
		-- un chunk nuevo en CADA línea de diálogo del bucle de tópicos (basura
		-- constante para el GC de la PS3). Ahora se resuelve la función global
		-- directamente, sin compilar nada.
		if monikatopic then
			local f = _G['ch30_'..monikatopic]
			if f then f() end
		end
	end
...
function ch30_reload_2()
	...
	elseif cl == 180 then
	cw('m',"Bueno, estás jugando desde la "..g_system..", ve a «Ajustes» y encuentra el botón «Personajes».")
	elseif cl == 181 then
