function ch0script()
	...
	elseif cl == 10017 then
		cw('bl','Tanto el juego original como el port no es apto para menores o\npersonas sensibles.')
	elseif cl == 10018 then
		cw('bl','Si padeces ansiedad o depresión, te instamos a que dejes de jugar inmediatamente. Si quieres saber más, visita este enlace:\nhttps://tinyurl.com/ddlcglow')
