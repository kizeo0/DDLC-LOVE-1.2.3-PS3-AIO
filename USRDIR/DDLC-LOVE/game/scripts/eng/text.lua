...
tr.help = {
	'Buttons and Guide',
	'',
	'(X): Advances in the game, selects options, etc.',
	'Start: Exits the menu, toggles auto-mode.',
	'(R1): Toggles jump mode.',
	'Triangle: Enters and exits the game menu.',
	'Circle: Shows or hides the dialogue box.',
	'',
	'Manage Characters: Go to Settings > Characters',
	'Delete Saved Data: To delete saved data, go to the following path:',
