function ch0script()
	...
	elseif cl == 10017 then
		cw('bl','This port, or the original game is not suitable for children\nor those who are easily disturbed.')
	elseif cl == 10018 then
		cw('bl','Individuals suffering from anxiety or depression may not have a safe experience playing this game. For content warnings, please visit:\nhttps://ddlc.moe/warning.html')
